# -*- coding: utf-8 -*-
"""
Created on Wed Nov 18 16:57:27 2020
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the use the
    partially guessed word so fat, as well as lettes that the
    user has not yet guessed.
Follows the other limitations detailed in the problem write-up.

    '''
    print ("Welcome to the game, Hangman!")
    print("I'm thinking of a word taht is " + str(len(secretWord)) + " letters long.")
    lettersGuessed = ''
    guessesLeft = 8
    print("-----------")
    while True:
        ...
        if guess in secretWord and guess not in lettersGuessed:
            ...
            print("Oops! You've already guessed that letters: " + getGuessedWord(secretWord, lettersGuessed))
            guessesLeft -= 1
        print("-----------")
        if guessesLeft <= 0:
